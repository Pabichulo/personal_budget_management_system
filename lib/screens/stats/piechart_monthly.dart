...
class MyMonthlyPieChart extends StatefulWidget {
  ...
  const MyMonthlyPieChart(this.expenses, {super.key});

  @override
  State<StatefulWidget> createState() => MyMonthlyPieChartState();
}

class MyMonthlyPieChartState extends State<MyMonthlyPieChart> {
  int touchedIndex = -1;
