...
class MyMonthlyChart extends StatefulWidget {
  final List<Expense> expenses;

  const MyMonthlyChart(this.expenses, {super.key});

  @override
  State<MyMonthlyChart> createState() => _MyChartState();
}

class _MyChartState extends State<MyMonthlyChart> {
  @override
