...
class _MainScreenState extends State<MainScreen> {
        ...
        children: [
          Padding(
            ...
            child: Column(
              children: [
                      ...
                      children: [
                        IconButton(
                          ...
                          icon: const Icon(
                            ...
                            color: Color.fromARGB(255, 33, 0, 39),
                          ),
                        ),
                        IconButton(
                          onPressed: () {
                ...
                BlocProvider(
                  create: (context) => GetMoneyBloc(FireBaseExpenseRepo())..add(GetMoney(widget.user.uid)),
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => AllExpense(expenses, widget.user)),
                        );
                      },
                      child: const Text(
                        "View All",
          ...
          Positioned(
            ...
            child: FloatingActionButton(
              onPressed: () async {
                context.read<GetMoneyBloc>().add(GetMoney(widget.user.uid));
                // Update the expenses list here
                final updatedExpenses = await fetchExpenses(widget.user.uid); // Assuming this function fetches the updated expenses
                setState(() {
  ...
  Future<List<Expense>> fetchExpenses(String userId) async {
    // Fetch the updated expenses from your repository or service
    final expenseRepository = FireBaseExpenseRepo();
    return await expenseRepository.getAllExpense(userId);
  }
}
